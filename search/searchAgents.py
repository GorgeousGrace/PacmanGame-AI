...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    # closestDistance = min([util.manhattanDistance(position, food) for food in foodList])
    #expanded nodes:12372
    # closestDistance = min([mazeDistance(position, food,problem.startingGameState) for food in foodList])
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState: pacman.GameState):
        ...
        "*** YOUR CODE HERE ***"
        # Use the built-in search algorithms to find a path to any food pellet
